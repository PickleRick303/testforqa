...
const App = ({ onClose }) => {
  ...
  const formik = useFormik({
    ...
    validate: (values) => {
      let errors = {};
      const reqFields = ['login', 'password', 'passwordRetry', 'age'];
          ...
          <Row gutter={[4, 4]}>
            ...
            <Col span={24}>
              <label>
                <Typography.Text>
                  {' '}
                  Пароль<span style={{ paddingLeft: 5, color: 'red' }}>*</span>
                </Typography.Text>
                <br />
                <Input.Password
            ...
            <Col span={24}>
              <label>
                ...
                <Input.Password
                  ...
                  maxLength={32}
                  onChange={(event) => {
                    setFieldValue('passwordRetry', event.target.value.trim());
                  }}
                ></Input.Password>
              </label>
              <br />
